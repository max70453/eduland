...
const chart = d3.select('#chart');
    ...
    aboutText
      .append('tspan')
        .text(`Hey, I'm Christopher Nourse`)
      //.append('tspan')
      //  .attr('dy', 20)
      //  .attr('x', 0)
      //  .text('This site describes me, briefly.')

    aboutText
      .append('tspan')
        .attr('dy', 30)
        .attr('x', 0)
        .text('I\'m a Product Manager based in London.')
      .append('tspan')
        .attr('dy', 20)
        .attr('x', 0)
        .text('I made this to be an interactive personal site.')
   
    aboutText
      .append('tspan')
        .attr('dy', 20)
        .attr('x', 0)
        .text('It should be serving at ')
    
    aboutText
      .append('a')
        .attr('class', 'link-in-text')
        .attr('xlink:href', 'http://cnourse.com/')
        .attr('target', '_blank')
        .text("cnourse.com")

    aboutText.append('tspan').text('.');

    aboutText
      .append('tspan')
        .attr('dy', 30)
        .attr('x', 0)
        .text("If you like this sort of thing")
    ...
    aboutText
      .append('a')
        .attr('class', 'link-in-text')
        .attr('xlink:href', 'mailto:nourse.christopher@gmail.com')
        .text('nourse.christopher@gmail.com')
    ...
    designText
      .append('tspan')
        .text('Here you could mention all the ')
      .append('tspan')
        .attr('dy', 20)
        .attr('x', 0)
        .text('design projects you\'ve done.')
    ...
    codeText
      .append('tspan')
        .text('Place links to marvelous projects here.')
